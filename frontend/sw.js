...
const CACHE="tt-cache-v26-ui";
const ASSETS=["/","/index.html","/styles.css","/app.js","/manifest.webmanifest","/favicon.ico","/favicon-32.png","/favicon-16.png","/apple-touch-icon.png","/icons/icon-192.png","/icons/icon-512.png"];
